...
----------------------------------------------------------------------------
Временно приостановил демонстрацию программирования БД, тк занят проектом по созданию ИИ (искусственный интелект), для этого потребовался революционый язык JavaScript. ВСЕ! ЖДИТЕ Я ВЕРНУСЬ! )))
